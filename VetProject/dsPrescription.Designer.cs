...
namespace VetProject {
    ...
    public partial class dsPrescription : global::System.Data.DataSet {
        ...
        public partial class medicineDataTable : global::System.Data.TypedTableBase<medicineRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public medicineRow AddmedicineRow(string name, int unitID, int price) {
        ...
        public partial class medicineRow : global::System.Data.DataRow {
            ...
            public int unitID {
                get {
                    return ((int)(this[this.tablemedicine.unitIDColumn]));
                }
                set {
                    this[this.tablemedicine.unitIDColumn] = value;
                }
            }
...
namespace VetProject.dsPrescriptionTableAdapters {
    ...
    public partial class medicineTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `medicine` WHERE ((`ID` = @p1) AND (`name` = @p2) AND (`unitID` = @p3" +
                ") AND (`price` = @p4))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `medicine` (`name`, `unitID`, `price`) VALUES (@p1, @p2, @p3)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `medicine` SET `name` = @p1, `unitID` = @p2, `price` = @p3 WHERE ((`ID` = " +
                "@p4) AND (`name` = @p5) AND (`unitID` = @p6) AND (`price` = @p7))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `ID`, `name`, `unitID`, `price` FROM `medicine`";
        ...
        public virtual int Fill(dsPrescription.medicineDataTable dataTable) {
        ...
        public virtual dsPrescription.medicineDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            dsPrescription.medicineDataTable dataTable = new dsPrescription.medicineDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(dsPrescription.medicineDataTable dataTable) {
