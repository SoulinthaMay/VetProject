...
namespace VetProject {
    ...
    public partial class dsPatient : global::System.Data.DataSet {
        ...
        public partial class prescriptionDataTable : global::System.Data.TypedTableBase<prescriptionRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public prescriptionRow AddprescriptionRow(int patientID, int vetID, int qty, int total, System.DateTime date, string time, string status) {
        ...
        public partial class prescriptionRow : global::System.Data.DataRow {
            ...
            public int vetID {
                get {
                    return ((int)(this[this.tableprescription.vetIDColumn]));
                }
                set {
                    this[this.tableprescription.vetIDColumn] = value;
                }
            }
            ...
            public int total {
                get {
                    return ((int)(this[this.tableprescription.totalColumn]));
                }
                set {
                    this[this.tableprescription.totalColumn] = value;
                }
            }
...
namespace VetProject.dsPatientTableAdapters {
    ...
    public partial class prescriptionTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `prescription` WHERE ((`ID` = @p1) AND (`patientID` = @p2) AND (`vetI" +
                "D` = @p3) AND (`qty` = @p4) AND (`total` = @p5) AND (`date` = @p6) AND (`time` =" +
                " @p7) AND (`status` = @p8))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `prescription` (`patientID`, `vetID`, `qty`, `total`, `date`, `time`," +
                " `status`) VALUES (@p1, @p2, @p3, @p4, @p5, @p6, @p7)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `prescription` SET `patientID` = @p1, `vetID` = @p2, `qty` = @p3, `total` = @p4, `date` = @p5, `time` = @p6, `status` = @p7 WHERE ((`ID` = @p8) AND (`patientID` = @p9) AND (`vetID` = @p10) AND (`qty` = @p11) AND (`total` = @p12) AND (`date` = @p13) AND (`time` = @p14) AND (`status` = @p15))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::VetProject.Properties.Settings.Default.veterinaryConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `ID`, `patientID`, `vetID`, `qty`, `total`, `date`, `time`, `status` FROM " +
                "`prescription`";
        ...
        public virtual int Fill(dsPatient.prescriptionDataTable dataTable) {
        ...
        public virtual dsPatient.prescriptionDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            dsPatient.prescriptionDataTable dataTable = new dsPatient.prescriptionDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(dsPatient.prescriptionDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(dsPatient dataSet) {
        ...
        public virtual int Delete(int p1, int p2, int p3, int p4, int p5, System.DateTime p6, string p7, string p8) {
        ...
        public virtual int Insert(int p1, int p2, int p3, int p4, System.DateTime p5, string p6, string p7) {
        ...
        public virtual int Update(int p1, int p2, int p3, int p4, System.DateTime p5, string p6, string p7, int p8, int p9, int p10, int p11, int p12, System.DateTime p13, string p14, string p15) {
    ...
    public partial class TableAdapterManager : global::System.ComponentModel.Component {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        private int UpdateUpdatedRows(dsPatient dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._prescriptionTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        private int UpdateInsertedRows(dsPatient dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._prescriptionTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        private int UpdateDeletedRows(dsPatient dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows) {
            int result = 0;
            if ((this._prescriptionTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        public virtual int UpdateAll(dsPatient dataSet) {
            if ((dataSet == null)) {
